import type { CookieOptions, Geo } from "./types";
        ...
        if (typeof parsed.location === "object" && parsed.location !== null) {
            ...
            if (typeof loc.coordinates === "object" && loc.coordinates !== null) {
                ...
                if (typeof loc.coordinates.latitude === "number")
                    geo.location.coordinates.latitude = loc.coordinates.latitude;
                if (typeof loc.coordinates.longitude === "number")
                    geo.location.coordinates.longitude = loc.coordinates.longitude;
                if (typeof loc.coordinates.accuracyRadius === "number")
                    geo.location.coordinates.accuracyRadius = loc.coordinates.accuracyRadius;
            }
