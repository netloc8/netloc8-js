...
import { readGeoHeaders, withGeoRedirect } from './proxy';
...
describe('header transport round-trip', () => {
    ...
    function makeHeaders(geo: Geo): Headers {
        ...
        const headerMap: [string, string | undefined][] = [
            ...
            ['x-netloc8-country-unions', geo.location?.country?.unions ? JSON.stringify(geo.location.country.unions) : undefined],
